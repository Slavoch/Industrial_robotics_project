...
int main(int argc, char **argv) {
    ...
    while(n.ok()) {
     ...
     //  		ROS_INFO("Waiting for transform....");
		...
		tf::poseTFToMsg(box_tf, box_pose1);
		visual_tools.publishAxisLabeled(box_pose1, "object", rvt::SMALL);
		...
		visual_tools.prompt("Press NEXT to move to the next position");
...
*/
		...
		visual_tools.trigger();
		visual_tools.prompt("Press NEXT to plan square move");
