...
//	pcl::visualization::PCLVisualizer visu3("Alignment");
//	visu3.addPointCloud(scene, ColorHandlerT(scene, 0.0, 255.0, 255.0), "scene");
//	visu3.spin();
//
//	pcl::visualization::PCLVisualizer visu4("Alignment");
//	visu4.addPointCloud(object, ColorHandlerT(scene, 255.0, 255.0, 0.0), "scene");
//	visu4.spin();
