...
//		joint_group_positions[1] = 10 * DEG_TO_RAD;
//		joint_group_positions[2] = 10 * DEG_TO_RAD;
//		joint_group_positions[3] = 10 * DEG_TO_RAD;
//		joint_group_positions[4] = 10 * DEG_TO_RAD;
//
//		group.setJointValueTarget(joint_group_positions);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		translate_to_complex_obj_oZ.getOrigin().setX(0.0525);//was 0.0525 for center
		translate_to_complex_obj_oZ.getOrigin().setY(0.025);//was -0.0007
